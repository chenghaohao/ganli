...
import com.ganli.service.HttpResponseHandler;
import com.ganli.service.MkkHttpResponse;
...
public class HttpClientExecutor {
    ...
    * */
    ...
    public void execute(HttpResponseHandler responseHandler,final RequestBuilder builder) {
        try {
            final CloseableHttpResponse response = sendRequest(builder);
    ...
    * */
    public void executeWithException(HttpResponseHandler responseHandler) throws Exception {
        final CloseableHttpResponse response = sendRequest(RequestBuilder.get());
        responseHandler.handleResponse(new MkkHttpResponse(response));
        response.close();
    }


    protected CloseableHttpResponse sendRequest(final RequestBuilder builder) throws Exception {
        HttpUriRequest request = retrieveHttpRequest(builder);
    ...
    private HttpUriRequest retrieveHttpRequest(final RequestBuilder builder) {
